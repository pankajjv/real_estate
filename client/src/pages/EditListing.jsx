...
function EditLisitng() {
    ...
    const handleSubmit =async(e)=>{
        ...
        try {
            ...
            const result = await fetch(`http://localhost:3001/api/listing/update/${id}`,{
                method: 'POST',
                headers: {
    ...
    <div className='max-w-4xl mx-auto'>
        ...
        <form className='p-4 flex flex-col sm:flex-row gap-4'>
            ...
            <div className='flex flex-col gap-4'>
                <input className='rounded p-2 focus:outline-none' value={formData.name} id='name' type="text" placeholder='Name' required onChange={handleChange}/>
                <textarea  className='rounded p-2 focus:outline-none' value={formData.description} id='description' placeholder='Description' required onChange={handleChange}/>
                <input className='rounded p-2 focus:outline-none' value={formData.address} id='address' type="text" placeholder='Address' required onChange={handleChange}/>
            </div>
            ...
            <div className='flex gap-6'>
                <div className='flex gap-2 items-center'>
                    <input id='bedrooms' className='p-2 rounded focus:outline-none' value={formData.bedrooms} type='number' min={1} max={10} required onChange={handleChange}/>
                    <p>Beds</p>
                </div>
                <div className='flex gap-2 items-center'>
                    <input id='bathrooms' className='rounded p-2 focus:outline-none' value={formData.bathrooms} type='number'  min={1} max={10} required onChange={handleChange}/>
                    <p>Baths</p>
                </div>
            </div>
            <div className='flex  gap-2'>
            ...
            <div className='flex flex-col gap-4 flex-1'>
                ...
                <button disabled={loading}  onClick={handleSubmit} className='p-3 rounded-lg bg-slate-700 text-white hover:opacity-95 disables:opacity-80 uppercase'>{loading ? 'Updating': 'Update Listing'}</button>
            </div>
        </form>
    </div>
  )
